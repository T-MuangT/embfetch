...
if ($WestContent -match "embfetch") {
    ...
    # embfetch
    - name: embfetch-rtos
      url: https://github.com/t-muangt/embfetch-rtos
      revision: main
...
Copy-Item "$EmbfetchRoot\src\rtos\zephyr\nrf-connect\prj.conf.example" `
